...
<beans xmlns="http://www.springframework.org/schema/beans"
   ...
   <!--aop的配置-->
   <aop:config>
       <!--切入点 expression(表达式匹配要执行的方法):execution(修饰词 返回值 列名 方法名 参数) -->
...
### 8.3 MyBatis-Spring学习

引入Spring之前需要了解mybatis-spring包中的一些重要类；

http://www.mybatis.org/spring/zh/index.html

![图片](https://mmbiz.qpic.cn/mmbiz_png/uJDAUKrGC7JXnZ2vicYHdibF3mvk0w89CqKXn1bvBicZVeBJHGlFZOd8a6X5uzjVp6RnMR4ibS7hPdrHSxNGevkib0w/640?wx_fmt=png&tp=webp&wxfrom=5&wx_lazy=1&wx_co=1)
...
5、增加Dao接口的实现类；私有化sqlSessionTemplatex
